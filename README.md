...
<body>
        ...
        <div class="container">
            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    ...
                    <a href="#" class="service-button">شراء الروبوت</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <a href="#" class="service-button">شراء المؤشرات</a>
                </div>
                ...
                <div class="service-card">
                    ...
                    <a href="#" class="service-button">الاشتراك في الدورة</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="pricing-grid">
                ...
                <div class="pricing-card">
                    ...
                    <a href="#" class="service-button">اشترك الآن</a>
                </div>
                ...
                <div class="pricing-card popular">
                    ...
                    <a href="#" class="service-button" style="background: linear-gradient(to right, var(--secondary), #ffcc00); color: var(--primary);">اشترك الآن</a>
                </div>
    ...
    <script>
        ...
        // رسالة عند النقر على زر الشراء
        document.querySelectorAll('.service-button, .pricing-card .service-button').forEach(button => {
            button.addEventListener('click', function(e) {
                e.preventDefault();
                alert('🚀 مرحباً بك في Atlas Trade! هذه نسخة تجريبية من الموقع. في النسخة النهائية، سيتم توجيهك إلى صفحة الدفع الآمنة لإكمال عملية الشراء.');
            });
        });
